...
export const translations = {
  en: {
    ...
    colModel: 'Model',
    colCo2: (unit: string) => `CO₂ (${unit}, range)`,
    colWater: (unit: string) => `Water (${unit}, range)`,
  ...
  zh: {
    ...
    colModel: '模型',
    colCo2: (unit: string) => `CO₂（${unit}，范围）`,
    colWater: (unit: string) => `耗水（${unit}，范围）`,
    colEff: 'CO₂ / 千输出 token',
    colOrigin: '来源',
    colOpenClosed: '开源/闭源',
    colEnergySrc: '能耗来源',
  ...
  de: {
    ...
    colModel: 'Modell',
    colCo2: (unit: string) => `CO₂ (${unit}, Bereich)`,
    colWater: (unit: string) => `Wasser (${unit}, Bereich)`,
