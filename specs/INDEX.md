...
| 6J | `phase-6j-sourced-energy-upgrade.md` | measured energy for top-traffic models; `energy_measured_fraction` rises | ✅ done |
| 6K | `phase-6k-uncertainty-and-sensitivity.md` | `sensitivity.json` + dominant driver; thesis-grade methodology | ✅ done |
| 6L | `phase-6l-retro-tech-frontend.md` | retrofuturist re-skin, honesty surfaces preserved | ✅ done |
