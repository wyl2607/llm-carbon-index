...
![Dashboard Preview](./docs/screenshot.png "LLM Carbon Index Dashboard")
*(Screenshot placeholder - Live site reflects current UI)*
...
| vNext | 6J measured energy + idle (`energy_measured_fraction` 0→0.29) · 6M ranking→tiering · 6N physical embodied · 6P literature cross-validation · 6Q MoE active-param energy · 6O dynamic regime/batching · 6R ESG/CSRD Scope-2 export | ✅ done |
